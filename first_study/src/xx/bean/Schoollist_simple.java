...
public class Schoollist_simple implements java.io.Serializable {
	...
	/** default constructor */
	public Schoollist_simple() {
	}

	/** minimal constructor */
	public Schoollist_simple(Integer xxbh) {
		this.xxbh = xxbh;
	}

	/** full constructor */
	public Schoollist_simple(Integer xxbh, String xxmc, String xxms)
	{
		this.xxbh = xxbh;
		this.xxmc = xxmc;
		this.xxms = xxms;
