	...
	Exception {
		...
		if (parameterMap != null) {
			...
			while (iterator.hasNext()) {
				...
				parameterBuffer.append(key).append("=").append
...
parameterBuffer.toString());
	...
	private URLConnection openConnection(URL localURL) throws 
	...
	public static void main(String[] a) throws Exception{
		...
		map.put("fileroots", "¹þ¹þ");
		new HttpRequest().doPost("http://localhost:8080/Corver/corver",map);
	}
}