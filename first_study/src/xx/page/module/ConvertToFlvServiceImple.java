...
@Service("convertToFlv")
@Transactional
public class ConvertToFlvServiceImple {
    
  
    
    private static String ffmpegPath = "E:\\javaserve\\";
    ...
    private static boolean process(String inputPath,String outputpath) {
        int type = checkContentType(inputPath);
        boolean status = false;
        if (type == 0) {
            System.out.println("直接转成flv格式");
            status = processFLV(inputPath,inputPath,outputpath);// 直接转成flv格式
        } else if (type == 1) {
            String avifilepath = processAVI(type,inputPath,outputpath);
            if (avifilepath == null)
                return false;// 没有得到avi格式
            status = processFLV(avifilepath,inputPath,outputpath);// 将avi转成flv格式
        }
        return status;
    }
    ...
    private static String processAVI(int type,String inputPath,String outputPath) {
        ...
        commend.add("avi");
        commend.add("-o");
        String newName=outputPath.substring(0,outputPath.lastIndexOf("."));
        commend.add(newName + ".avi");
        try {
...
//public class ConvertToFlvServiceImple implements ConvertToFlvService {
//    
//    private static String inputPath = "H://input//开班简介.avi";
//    
//    private static String outputPath = "G://";
//    
//    private static String ffmpegPath = "E:\\javaserve\\";
//   
//    public  boolean convert(String inputFile, String outputFile)    
...
//public class ConvertToFlvServiceImple implements ConvertToFlvService{  
//      
//    private static String mencoder_home = "E:\\javaserve\\mencoder.exe";//mencoder.exe所放的路径  
//    private static String ffmpeg_home = "E:\\javaserve\\ffmpeg.exe";//ffmpeg.exe所放的路径  
//      
//    public static String inputFile_home = "E:\\javaserve\\input\\1.wmv";//需转换的文件的位置  
//    public static String outputFile_home = "E:\\javaserve\\output\\2.flv";//转换后的flv文件所放的文件夹位置  
//    private String tempFile_home="E:\\javaserve\\tempFile_home";//存放rm,rmvb等无法使用ffmpeg直接转换为flv文件先转成的avi文件  
//       
//    
//       
//        /**  
...
//			
//			convertSingleVideo.convert("H://input//开班简介.avi", "H://input//output//java开班简介.flv");
//			
//        }
//    }    