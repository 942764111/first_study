...
/**
 * JieId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class JieId implements java.io.Serializable {
	...
	/** full constructor */
	public JieId(Integer zbh, Integer CId) {
		this.zbh = zbh;
		this.CId = CId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JieId))
			return false;
		JieId castOther = (JieId) other;
