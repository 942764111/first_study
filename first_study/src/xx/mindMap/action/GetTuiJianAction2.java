 ...
 * @author fish 
 */  
public class GetTuiJianAction2 extends ActionSupport  
{  
	...
	@Action(value="gettuijian2",results={@Result(name="success",type="json")})
	public String gettuijian() throws Exception  
	{  
	
		List<Map<String, String>> mDetails=this.adminService.querytuijian2(nodeid,"1");
