 ...
 * @author fish 
 */  
public class MindMapAction2 extends ActionSupport  
{  
	...
	@Action(value="getmindJson",results={@Result(name="success",type="json")})
	public String getmindJson() throws Exception  
	{  
