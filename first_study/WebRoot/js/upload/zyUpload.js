	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var defaults = {
					...
					url              : "upload_file.action?jsessionid=wzh",  	// 上传文件的路径
			...
			this.createHtml = function(){
				...
				html += '		<div id="uploadInf" class="upload_inf"><table id="dataTable"><thead id="table1_header" class="datagrid-header"></thead><tbody id="table1_body" class="datagrid-body"></tbody></table><div id="btn"></div></div>';
				html += '	</div>';
				html += '</form>';
				//html += '		<div id="uploadInf" class="upload_inf"><div class="datagrid-view"><div class="datagrid-header" style="width: 626px;"><div class="datagrid-header-inner" style="display: block;"><table border="0" cellspacing="0" cellpadding="0" style="height: 21px;" id="table1_header"><tbody></tbody></table></div></div><div class="datagrid-body" style="width: 626px;"><table cellspacing="0" cellpadding="0" border="0" id="table1_body"><tbody></tbody></table></div></div></div></div>';
			...
			this.funFilterEligibleFile = function(files){
				...
				for (var i = 0, file; file = files[i]; i++) {
					if (file.size >= 51200000) {
						...
						//if(fileExt==".png" || fileExt==".gif" || fileExt==".jpg" || fileExt==".jpeg"|| fileExt==".flv" || fileExt==".swf" || fileExt==".pdf"|| fileExt==".doc||")
			...
			this.createCorePlug = function(){
				var params = {
					...
					onSuccess: function(file, response) {
						...
						htm +='<th><tr><td field="no" class=""><div class="datagrid-cell" style="width: 27.6px; text-align: left; cursor: default;">';
						htm +='<span>编号</span><span class="datagrid-sort-icon">&nbsp;</span></div></td>';
						htm +='<td field="wjmc" class=""><div class="datagrid-cell" style="width: 178.6px; text-align: left; cursor: default;">';
						htm +='<span>文件名称</span><span class="datagrid-sort-icon">&nbsp;</span></div></td>';
						htm +='<td field="zlmc"><div class="datagrid-cell" style="width: 178.6px; text-align: left;">';
						htm +='<span>资料名称</span><span class="datagrid-sort-icon">&nbsp;</span></div></td>';
						htm +='<td field="zlly"><div class="datagrid-cell" style="width: 178.6px; text-align: left;">';
						htm +='<span>资料来源</span><span class="datagrid-sort-icon">&nbsp;</span></div></td>';
						htm +='<td field="zlscm"><div class="datagrid-cell" style="width: 178.6px; text-align: left;">';
						htm +='<span>资料素材名</span><span class="datagrid-sort-icon">&nbsp;</span></div></td>';
						htm +='<td field="zlms" class=""><div class="datagrid-cell" style="width: 240.8px; text-align: left; cursor: default;">';
						htm +='<span>资料描述</span><span class="datagrid-sort-icon">&nbsp;</span></div></td></tr></th>';
						
					    
						ht +='<tr datagrid-row-index="0" class="" style="height: 21px;">';
						ht +='<td field="no" id="no"><input type="text" id="no" name="no" value='+r.no+' disabled></td>';
						ht +='<td field="fileName"><input type="text" id="fileName" name="fileName" style="width: 178.6px;" value='+r.fileName+' disabled></td>';
						ht +='<td field="zlmc"><input type="text" id="zlmc" name="zlmc" required></td>';
						ht +='<td field="zlly"><input type="text" id="zlly1" name="zlly" required></td>';
						ht +='<td field="nr"><input type="text" id="zlscm" name="zlscm" required></td>';
						ht +='<td field="wjms"><input type="text" id="zlms" name="zlms" width=100% required></td>';
						
						ht +='<td field="lxm"><input type="hidden" id="lxm" name="lxm" value='+r.lxm+' disabled></td>';
						ht +='<td field="tip"><input type="hidden" id="tip" name="tip" value="jxnr" disabled></td>';
						ht +='<td field="scrq"><input type="hidden" id="scrq" name="scrq" value='+r.scrq+' disabled></td>';
						ht +='<td field="filePath"><input type="hidden" id="filePath" name="filePath" value='+r.filePath+' disabled></td>';
						
						ht +='<td field="changdu"><input type="hidden" id="changdu" name="changdu" value='+r.changdu+' disabled></td>';
						ht +='<td field="newFileName"><input type="hidden" id="newFileName" name="newFileName" value='+r.newFileName+' disabled></td>';
						
						
						//html+='</tr></table></div>';
						
						$("#table1_header").html(htm);
						$("#table1_body").append(ht);
						
						
						$('#btn').html('<button class="easyui-linkbutton"  type="button" iconCls="icon-ok" href="javascript:void(0)" onclick="addwin()">提交</button>');
