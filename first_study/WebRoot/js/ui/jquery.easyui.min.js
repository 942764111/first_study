...
$("<td style=\"font-size:12px\">每页数据个数:</td>").append(ps).appendTo(tr);
...
if (typeof(sfcx)!='undefined')
{
	if(sfcx==1)
	{
		$('#test_t').datagrid('options').queryParams={};
		$('#test_t').datagrid('options').url="gets";
		sfcx=0;
	}
...
$.fn.pagination.defaults={total:1,pageSize:15,pageNumber:1,pageList:[15,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_75,_76){
},onBeforeRefresh:function(_77,_78){
},onRefresh:function(_79,_7a){
},onChangePageSize:function(_7b){
},beforePageText:'第',afterPageText:'页',displayMsg:'当前显示从{from}到{to},共有{total}条记录'};
})(jQuery);
(function($){
function _7c(_7d){
var _7e=$(_7d);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"请填入数据",invalidMessage:null,rules:{email:{validator:function(_2fb){
...
if(opts.pagination){
$.extend(_47a,{page:opts.pageNumber,rows_s:opts.pageSize});
}
if(opts.sortName){
