...
function GooUploader(Div,property){
	...
	//渲染this.$div
	this.$div.addClass("Uploader").css({width:"650px",height:this.$height-4+"px"});
	this.$div.append("<div class='total_bg'><div class='oper' style='width:"+"650px;'></div>"+
					"<div class='content' style='height:"+(this.$height>36?(this.$height-40):30)+"px;width:"+
					(this.$multiple?(650):(650))+"px;"+(this.$multiple?"":"margin:0px;")+"'></div></div>");
