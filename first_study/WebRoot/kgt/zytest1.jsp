	...
	<div region="center">
		<div id="tt"  fit="true" class="easyui-tabs" style="width:1070px;height:573px;">
			...
			<div class="easyui-layout" fit="true" style="width:900px;padding:10px;height:392px">
				<div id="xzcs"  region="north" style="width:900px;padding:5px;height:95px">
					<form>
						...
						<br>
						您也可以通过知识点选择测试范围:
							知识点名称:<input id="zsdmc" type="text" style="width:160px;"/>
							<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="xzcs()">确定</a><br>(注：如果两种方式都选，则默认按照知识点名称确定范围)
					</form>
					</div>
				...
				<div region="center" id="x1" style="padding:10px;overflow-x:hidden;overflow-y:hidden;">
					...
					<div region="east" id="x2" split="false" style="width:130px;padding:0px;">
						<div style="padding:5px;margin-top:30px;margin-left:0px;">
							<center>
								<br><br><br>
			...
			<div title="判断题自测">
			<div class="easyui-layout" fit="true" style="width:900px;padding:10px;height:392px">
				<div id="pdcs"  region="north" style="width:900px;padding:5px;height:95px">
					<form>
						...
						<br>
						您也可以通过知识点选择测试范围:
							知识点名称:<input id="zsdmcp" type="text" style="width:160px;"/>
							<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="pdcs()">确定</a><br/>(注：如果两种方式都选，则默认按照知识点名称确定范围)
					</form>
					<br>
					</div>
					...
					<div region="east" id="pd" split="false" style="width:130px;padding:0px;">
						<div style="padding:5px;margin-top:40px;margin-left:0px;">
							<center>
		...
		<div id="xzjg" class="easyui-window" closed="true" title="结果分析" style="padding:5px;width:360px;height:280px;"  maximizable="false" minimizable="false" collapsible="false"></div>
	</div>
	</body>
</html>
