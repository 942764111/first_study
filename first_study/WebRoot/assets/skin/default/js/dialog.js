...
{
    var defaults = { // 默认值。 
        title:'查看资料',       // 标题文本，若不想显示title请通过CSS设置其display为none 
    ...
    var barHtml = !options.showTitle ? '' :
        '<div class="bar" background:><span class="title">' + options.title + '</span><a class="close">' + options.closeText + '</a></div>';
    ...
    this.show = function()
    {
        ...
        var getOpacity = function(id)
        {
            ...
            {   
            	...
            	if(a=="0.100000001490116"){
            		return "0.100000001490116";
            	}else{
            		return 1;
            	}
            	   }
